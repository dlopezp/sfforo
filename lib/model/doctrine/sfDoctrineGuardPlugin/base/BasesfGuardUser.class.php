 ...
 * @method sfGuardUser           setTemas()                 Sets the current record's "Temas" collection
 * @method sfGuardUser           setRespuestas()            Sets the current record's "Respuestas" collection
 * 
 * @package    sfforo
 * @subpackage model
 * @author     Daniel López
